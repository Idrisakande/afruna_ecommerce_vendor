    ...
    () => [
      {
        ...
        header: () => <span className="text-sm pl-24 text-[#7C7C7C]">ID</span>,
      },
      {
        accessorKey: "img",
        cell: ({ cell }) => (
      ...
      },
      {
        ...
        header: () => <span className="text-sm text-[#7C7C7C]">item Name</span>,
      },
      {
      ...
      <div className="flex flex-col items-end justify-end pt-8 border-t border-slate-300">
        <div className="max-w-[23rem] w-full gap-10 flex justify-between items-center">
          <div className="flex flex-col min-w-[50%] gap-5 justify-start">
            <h3 className="text-sm text-[#777687] font-semibold">Sub Total:</h3>
          ...
          <div className="flex flex-col gap-5 min-w-[50%] justify-start">
            ...
            <span className="text-sm text-[#777687] font-semibold">$28.15</span>
            <span className="text-sm text-[#777687] font-semibold">$2.15</span>
          </div>
        </div>
