...
const ProductCategories: FC<ProductCategoriesProps> = () => {
  ...
  return (
    <Main breadcrumbs={<Breadcrumbs />}>
      <main className="m-10 xl:mx-12 pb-28">
        <div className="flex flex-col lg:flex-row justify-between gap-5 bg-white mt-8 p-8 lg:px-10 rounded-xl border border-slate-300">
          <div className="flex flex-wrap flex-col gap-5 md:flex-row lg:min-w-[35rem]">
            ...
            <SortItem
              ...
              item_1={"Fashion"}
              item_2={"Art & Craft"}
              item_3={"Afruna movies"}
              item_4={"Books"}
              item_5={"Computer Accessories"}
              className={"max-w-[20rem] md:max-w-[13rem]"}
            />
          </div>
          <button
            onClick={() => setAddCategoryModelOpen(true)}
